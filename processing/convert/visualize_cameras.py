...
if __name__ == '__main__':
    ...
    sphere_radius = 1.
    # train_cam_dict = json.load(open(os.path.join(base_dir, 'camdict.json')))
    train_cam_dict = json.load(open(sys.argv[1]))
    ...
    colored_camera_dicts = [(color, {str(key): val}) for color, (key, val) in zip(colors, sorted(train_cam_dict.items()))]

    print(colored_camera_dicts)
    # colored_camera_dicts = [
    #         ([0, 0, 0], {'0': train_cam_dict['0.png']}),
    #         ([1, 0, 0], {'1': train_cam_dict['1.png']}),
    #         ([0, 1, 0], {'2': train_cam_dict['2.png']}),
    #         ([0, 0, 1], {'3': train_cam_dict['3.png']}),
    #         ([1, 1, 0], {'4': train_cam_dict['4.png']}),
    #         ([1, 0, 1], {'5': train_cam_dict['5.png']}),
    #                         # ([0, 0, 1], test_cam_dict),
    #                         # ([1, 1, 0], path_cam_dict)
    #                         ]
