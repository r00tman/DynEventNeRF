...
# 6
printf "%s\n" "${cameras[@]}" | xargs -n 1 -P $max_processes -I {} bash -c "./edi3 -p 0.3 -n -0.5 -a ${startT} -b ${endT} --t0=${commont0} -r ${fps} -e 0e-3 -s linear -c {} -o rec-2024_01_18_18_33_17_seq2_{}_vng.mp4 -i ${file} --debayering vng"
