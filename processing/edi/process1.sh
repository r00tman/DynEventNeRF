...
printf "%s\n" "${cameras[@]}" | xargs -n 1 -P $max_processes -I {} bash -c "./edi3 -p 0.7 -n -0.7 -a 0 -b ${duration} --t0=${commont0} -r 25 -e 12e-3 -s srgb -c {} -o calib_24-01-18_0707_{}_vng.mp4 -i ${file} --debayering vng"
