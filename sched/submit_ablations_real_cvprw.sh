...
wolacclevent=${fullmodel}" --use_accumulation_loss False --use_event_loss False"
wolacclevent1=${fullmodel}" --is_rgb_only True"
...
# for scene in 24-04-30_80_90_5fps_ls0.5_3e-2 24-04-30_314_319_5fps_ls0.5_3e-2 24-04-30a_207_168_5fps_ls0.5_3e-2; do
    ...
    ./scripts/launcher_multi_archive.sh python ./ddp_train_nerf.py --expname cvprwfullrealablations_wolacclevent_${scene} --scene data/dynsyn/${scene} $common $sceneargs $wolacclevent
    # ./scripts/launcher_multi_archive.sh python ./ddp_train_nerf.py --expname cvprwfullrealablations_wolacclevent1_${scene} --scene data/dynsyn/${scene} $common $sceneargs $wolacclevent1
done
