#!/usr/bin/env bash
folder=$1
ffmpeg -y -i ${folder}/render_test_*_r_00050_.* -i ${folder}/render_test_*_r_00383_.* -i ${folder}/render_test_*_r_00716_.* -filter_complex "[0][1][2]hstack=inputs=3[vout]" -map "[vout]" -crf 10 ${folder}/test_comp.mp4
